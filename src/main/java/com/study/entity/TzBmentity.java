...
public class TzBmentity {
     ...
     * 获取BM表外键
     *
     * @return BUSMODULE_ID - BM表外键
     */
    public String getBusmoduleId() {
        return busmoduleId;
    }
     ...
     * 设置BM表外键
     *
     * @param busmoduleId BM表外键
     */
    public void setBusmoduleId(String busmoduleId) {
        this.busmoduleId = busmoduleId;
    }
