package com.study.AA_Utils;//package com.study.AA_utils;
...
public class Lincense {
  ...
  private String licenseIdpre = "personLN";
  private String licensePermissionIdpre = "personLNPM";
