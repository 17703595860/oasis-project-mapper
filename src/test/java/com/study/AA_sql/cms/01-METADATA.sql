...
INSERT INTO `TZ_FIELD`(`ID`, `NAME`, `BUSENTITY_ID`, `JOIN_NAME`, `COL_NAME`, `CALCULATED`, `CALCVAL`, `DATA_TYPE`, `TEXTLEN`, `PREC_NUM`, `SCALE`, `REQUIRED`, `FORCEACTIVE`, `ACTIVE_FLG`, `COMMENTS`, `MODIFICATION_NUM`, `CONTROL_TYPE`, `PT_BENAME`, `TRANSFORM_CODE`) VALUES
  ...
  ('cmsField0000000045', 'TempId', 'cmsBE0000000000002', null, 'TEMP_ID', null, null, 'Varchar', 18, null, 0, 'Y', 'N', 'Y', null, 1, 'prompt', 'TZArtAddType', null),
  ('cmsField0000000046', 'ArtTypeId', 'cmsBE0000000000002', null, 'ART_TYPE_ID', null, null, 'Varchar', 18, null, 0, 'N', 'N', 'Y', null, 1, 'string', null, null),
