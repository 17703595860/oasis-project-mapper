...
public class DispframeModule_2 {
    ...
    private Integer dispFrameIdA = 24;
    private Integer dispFrameElementIdA = 279;
    private Integer dispFrameFldJumpIdA = 45;
    ...
    String beName = "TZSiteTemp";
    String datasetFlg = "Admin";
    String filterName = "TZSiteTempFilter";
