...
public class MetadataModule {
  ...
  private List<Be> beList = new ArrayList<Be>() {{
    add(new Be() {{
      ...
      setFilter(new FilterDfn(null, "TZOrgSiteFilter", Arrays.asList("NAME", "SITE_NAME", "SITE_TYPE", "SITE_DESC", "SITE_ENABLE")));
      setTransformList(new ArrayList<Transform>() {{
        add(new Transform("SITE_TYPE", "SITE_TYPE"));
        add(new Transform("SITE_ENABLE", "SITE_ENABLE"));
        add(new Transform("SITE_ISSUE", "SITE_ISSUE"));
      }});
      setZBeList(new ArrayList<Be>() {{
        add(new Be() {{
          ...
          setClassName("cn.com.tranzvision.oasis.basebizobj.BCEntity.TZBCEntityBase");
          setFilter(new FilterDfn(null, "TZSiteColuFilter", Arrays.asList("NAME", "COLU_TYPE", "COLU_ENABLE")));
          setTransformList(new ArrayList<Transform>() {{
            add(new Transform("COLU_TYPE", "SITE_COLU_TYPE"));
            add(new Transform("COLU_ENABLE", "SITE_COLU_ENABLE"));
          }});
          setPromptList(new ArrayList<Prompt>() {{
            add(new Prompt(null, "siteTempIdPrompt", "TEMP_ID", new Be() {{
              setBeName("TZSiteTemp");
        ...
        add(new Be() {{
          ...
          setTableName("TZ_SITE_TEMP");
          setClassName("cn.com.tranzvision.oasis.basebizobj.BCEntity.TZBCEntityBase");
          setFilter(new FilterDfn(null, "TZSiteTempFilter", Arrays.asList("NAME", "TEMP_TYPE", "TEMP_ENABLE")));
          setTransformList(new ArrayList<Transform>() {{
            add(new Transform("TEMP_TYPE", "SITE_TEMP_TYPE"));
            add(new Transform("TEMP_ENABLE", "SITE_TEMP_ENABLE"));
          }});
        }});
      }});
    }});
