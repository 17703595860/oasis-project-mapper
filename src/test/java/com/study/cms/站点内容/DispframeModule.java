...
public class DispframeModule {
    ...
    private String dispFrameIdpre = "cmsDispFrame100";
    private String dispFrameElementIdpre = "cmsDispEl100000";
    private String dispFrameFldJumpIdpre = "cmsDispJump1000";
    ...
    String beName = "TZSiteArt";
    String datasetFlg = "Admin";
    String filterName = "TZSiteArtFilter";

    boolean jumpFlag = false;
    String DetailComponentId = "cmsCOM100000000002";
