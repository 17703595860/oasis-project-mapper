package com.study.cms.站点内容;

import com.study.entity.TzBusentity;
import com.study.entity.TzDispframe;
import com.study.entity.TzDispframeElement;
import com.study.entity.TzDispframeFlddrilldown;
import com.study.entity.TzField;
import com.study.entity.TzFilterDfn;
import com.study.entity.TzJoin;
import com.study.entity.TzJoinSpec;
import com.study.mapper.TzBusentityMapper;
import com.study.mapper.TzDispframeElementMapper;
import com.study.mapper.TzDispframeFlddrilldownMapper;
import com.study.mapper.TzDispframeMapper;
import com.study.mapper.TzFieldMapper;
import com.study.mapper.TzFilterDfnMapper;
import com.study.mapper.TzJoinMapper;
import com.study.mapper.TzJoinSpecMapper;
...
public class DispframeModule_1 {
    ...
    private String dispFrameIdpre = "cmsDispFrame1";
    private String dispFrameElementIdpre = "cmsDispEl1000";
    ...
    List<String> beNameList = Arrays.asList("TZSiteArt", "TZSiteAddArt", "TZSiteArtImage", "TZSiteArtFile", "TZColuArt", "TZColuArtGroup");
    List<String> filterNameList = Arrays.asList("TZSiteArtFilter", "", "TZSiteArtImageFilter", "TZSiteArtFileFilter", "TZColuArtFilter", "TZColuArtGroupFilter");
    ...
    public void copyDisplayFrameAllByBeName() {
        ...
        try {
            ...
            for (int i = 0; i < beNameList.size(); i++) {
                String beName = beNameList.get(i);
                String filterName = filterNameList.get(i);
                copyDisplayOneBe(beName, filterName);
                dispFrameElementIdInsertList = new ArrayList<>();
                dispFrameIdInsertList = new ArrayList<>();

                dispFrameIdA += 20;
                dispFrameElementIdA += 1000;
            }
    ...
    private void copyDisplayOneBe(String beName, String filterName) {
        ...
        if (search && StringUtils.isNotBlank(filterName)) {
    ...
    private void addFileSql(String beName) {
        ...
        addframe(srcFilePath, beName);
    }

    private void addframe(String srcFilePath, String beName) {
