...
public class DispframeModule {
    ...
    private String dispFrameIdpre = "roomDispFrame";
    private String dispFrameElementIdpre = "roomDispEl000";
    private String dispFrameFldJumpIdpre = "roomDispJump0";
    ...
    String beName = "TZClassRoom";
    String datasetFlg = "Admin";
    String filterName = "TZClassRoomFilter";

    boolean jumpFlag = true;
    String jumpFieldName = "AddrNo";
    String DetailComponentId = "roomCOM00000000002";
