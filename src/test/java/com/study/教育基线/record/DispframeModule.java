...
public class DispframeModule {
    ...
    private String dispFrameIdpre = "recordDispFrame";
    private String dispFrameElementIdpre = "recordDispEl000";
    private String dispFrameFldJumpIdpre = "recordDispJump0";
    ...
    String beName = "TZRecord";
    String datasetFlg = "Admin";
    String filterName = "TZRecordFilter";

    boolean jumpFlag = false;
    String DetailComponentId = "recordCOM000000002";
