...
public class MetadataModule {
  ...
  private String beIdPre = "recordBE000000";
  private String fieldIdPre = "recordField000";
  private String joinIdPre = "recordJoin0000";
  private String joinSpecIdPre = "recordSpec0000";

  private String bmIdPre = "recordBM000000";
  private String bmBeIdPre = "recordBMBE0000";
  private String linkIdPre = "recordLink0000";

  private String messageIdPre = "recordMsg00000";
  private String messageInfIdPre = "recordMsgInf00";

  private String permissionGroupIdPre = "recordPMGroup0";
  private String permissionIdPre = "recordPM000000";

  private String promptIdPre = "recordPT000000";
  private String promptFieldIdPre = "recordPTFld000";

  private String filterDfnIdPre = "recordFilter00";
  private String filterFldIdPre = "recordsFltFld0";
  private String filterFldOperatorIdPre = "recordFldOpr00";
  ...
  private String module = "record";
  private String moduleDesc = "record模块";
  private Bm bm = new Bm(null, "TZRecord", "TZRecord", new HashMap<String, String>() {{
    put("retrieve", "查看");
    put("create", "新增");
    put("update", "修改");
    put("delete", "删除");
  ...
  private List<Be> beList = new ArrayList<Be>() {{
    add(new Be() {{
      setBeName("TZRecord");
      setEntityClass(TzRecord.class);
      setTableName("TZ_RECORD");
      setClassName("cn.com.tranzvision.oasis.basebizobj.BCEntity.TZBCEntityBase");
      setFilter(new FilterDfn(null, "TZRecordFilter", Arrays.asList("ORG_ID", "RECORD_NAME", "IS_RECORD_EDU")));
      setTransformList(new ArrayList<Transform>() {{
        add(new Transform("IS_RECORD_EDU", "IS_RECORD_EDU"));
      }});
      setPromptList(new ArrayList<Prompt>() {{
        add(new Prompt(null, "orgIdPrompt", "ORG_ID", new Be() {{
          setBeName("TZOrg");
          setEntityClass(TzOrganization.class);
          setTableName("TZ_ORGANIZATION");
        }}, "NAME", "ID", Arrays.asList("CODE", "NAME")));
      }});
    }});
  }};
  ...
  private void addBmSql(String srcFilePath) {
    ...
    try(BufferedWriter bw = new BufferedWriter(new FileWriter(filePath, true))) {
      // 添加link
      List<Map<String, List<String>>> objList = null;
      if (linkIdInsertList.size() != 0) {
        List<TzLink> linkList = tzLinkMapper.selectByIds(StringUtils.join(linkIdInsertList.stream().map(e -> "'" + e + "'").collect(Collectors.toList()), ","));
        objList = linkList.stream().map(this::getColAndVal).collect(Collectors.toList());
